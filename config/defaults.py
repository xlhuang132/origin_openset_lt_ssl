...
# T2T
_C.ALGORITHM.T2T=CN()
_C.ALGORITHM.T2T.STAGE1_STEPS=250*500
_C.ALGORITHM.T2T.STAGE2_STEPS=250*500
_C.ALGORITHM.T2T.MU=2
#== STAGE1
_C.ALGORITHM.T2T.T=1.
_C.ALGORITHM.T2T.LAMBDA_MU=1.
#== STAGE2
_C.ALGORITHM.T2T.FILTER_EVERY_STEP=20*500

# SOFTMATCH
_C.ALGORITHM.SOFTMATCH=CN()
_C.ALGORITHM.SOFTMATCH.HARD_LABEL=True
_C.ALGORITHM.SOFTMATCH.T=0.5
_C.ALGORITHM.SOFTMATCH.DIST_ALIGN=True
_C.ALGORITHM.SOFTMATCH.DIST_UNIFORM=True
_C.ALGORITHM.SOFTMATCH.EMA_P=0.999
_C.ALGORITHM.SOFTMATCH.N_SIGMA=2
_C.ALGORITHM.SOFTMATCH.PER_CLASS=False
_C.ALGORITHM.SOFTMATCH.AMP=False
_C.ALGORITHM.SOFTMATCH.LAMBDA_U=1.0
# MOOD
